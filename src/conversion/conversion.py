class Conversion:
    ...
    def texto_a_morse(self, texto):
        ...
        texto = texto.upper()
        resultado = [morse_dict[letra] for letra in texto if letra in morse_dict]
    ...
    def texto_a_morse(self, texto):
        ...
        texto = texto.upper()  # Aseguramos mayúsculas
        resultado = []
        for char in texto:
    ...
    def morse_a_texto(self, morse):
        ...
        morse_a_letra = {valor: clave for clave, valor in morse_dict.items()}
    
        resultado = []
        for simbolo in morse.split():
          if simbolo in morse_a_letra:
            resultado.append(morse_a_letra[simbolo])
        return "".join(resultado)